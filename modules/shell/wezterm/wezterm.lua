...
return {
 ...
 --   { key = 'U', mods = 'CTRL', action = act.CharSelect{ copy_on_select = true, copy_to =  'ClipboardAndPrimarySelection' } },
    ...
    { key = 'UpArrow', mods = 'SHIFT|ALT|CTRL', action = act.AdjustPaneSize{ 'Up', 1 } },
    { key = 'DownArrow', mods = 'SHIFT|ALT|CTRL', action = act.AdjustPaneSize{ 'Down', 1 } },
    -- { key = 'n', mods = 'SUPER', action = act.ActivatePaneDirection 'Left' },
    -- { key = 'i', mods = 'SUPER', action = act.ActivatePaneDirection 'Right' },
    -- { key = 'u', mods = 'SUPER', action = act.ActivatePaneDirection 'Up' },
    -- { key = 'e', mods = 'SUPER', action = act.ActivatePaneDirection 'Down' },
    ...
    { key = 'n', mods = 'SHIFT|ALT', action = act.ActivatePaneDirection 'Left' },
    { key = 'i', mods = 'SHIFT|ALT', action = act.ActivatePaneDirection 'Right' },
    { key = 'u', mods = 'SHIFT|ALT', action = act.ActivatePaneDirection 'Up' },
    { key = 'e', mods = 'SHIFT|ALT', action = act.ActivatePaneDirection 'Down' },
