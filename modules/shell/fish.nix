...

{
  programs.fish = { 
    ...
    shellAbbrs = {
        steamscopehud= "MANGOHUD_CONFIG=\"horizontal,background_alpha=0\" gamescope -w 3440 -h 1440 -W 3440 -H 1440 -F nis -r 120 -f -b -e -- mangohud steam -gamepadui"; # -b boarderless
