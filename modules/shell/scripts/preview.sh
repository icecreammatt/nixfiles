# https://raw.githubusercontent.com/mitsuhiko/dotfiles/master/helpers/preview.sh
...
bat --color always --style numbers,changes,grid --terminal-width=$(tput cols) --line-range $FIRST:$LAST "$FILE" --highlight-line $CENTER
