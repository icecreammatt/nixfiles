...

{
  ...
  home.file.".config/helix/config.toml".text = ''
    ...
    #   [KN] [..] [..] [..]
    # -------------------------
    "," = { Q = "wclose", q = ":buffer-close", w = ":w", "W" = ":write-quit", g = ":run-shell-command lazygit", r = ":theme catppuccin_frappe", R = ":theme dracula", m = ":lsp-workspace-command", p = "file_picker_in_current_directory", "," = ["collapse_selection", "keep_primary_selection"] }
